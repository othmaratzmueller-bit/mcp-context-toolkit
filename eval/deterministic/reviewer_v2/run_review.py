#!/usr/bin/env python3
"""Schickt den v2-Review-Prompt (traps.REVIEW_PROMPT — das minibank-Projekt + neues
Feature) an ein Reviewer-Modell und speichert die rohe Prosa-Antwort nach out/<label>.txt.
Kein Judge hier — gejudged wird lokal + deterministisch (score.py, Naehe-Anker). Key via
--api-key-file, nie geloggt. (Aufbau identisch zum reviewer_test-Runner, lokale traps.)"""
